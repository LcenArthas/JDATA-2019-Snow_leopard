...
def get_size(json_file, frame):
    p = json_file.split('/')[0]
    if p == 'coco_wider':
        pic = root_path + 'coco_wider/train2017/' + frame
    elif p == 'coco_mot15':
        pic = root_path + 'coco_mot15/train2017/' + frame
    elif p == 'coco_mot17':
...
def convert(json_list, json_file):
    ...
    for json_f in json_list:                                        #循环标签列表
        ...
        for frame in tqdm(json_dir.keys()):
            ...
            #复制图片
            shutil.copyfile(picfile, '/mnt/liucen/MOT_det/coco/train2017/'+filename)
...
if __name__ == '__main__':
    ...
    #设置转换的label文件
    print("开始最后的合并.....")
    json_list = ["coco_mot19/annotations/instances_train2017.json",
                 "coco_mot17/annotations/instances_train2017.json",]
    json_file = "/mnt/liucen/MOT_det/coco/annotations/instances_train2017.json"
