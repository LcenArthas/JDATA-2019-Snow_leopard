...
root_path = '/mnt/liucen/MOT_challenge/MOT_17/data/mot17/train/'
# 检测框的ID起始值
...
def convert(label_list, json_file):
    ...
    for label_txt in label_list:                                        #循环标签列表
        ...
        for frame in tqdm(txt_dir.keys()):
            ...
            #复制图片
            shutil.copyfile(picfile, '/mnt/liucen/MOT_det/coco_mot17/train2017/'+filename)
...
def MOT17_TO_COCO():
    #设置转换的label文件
    label_list = ['MOT17-13-SDP/gt/gt.txt','MOT17-11-SDP/gt/gt.txt', 'MOT17-10-SDP/gt/gt.txt',
                  'MOT17-09-SDP/gt/gt.txt', 'MOT17-05-SDP/gt/gt.txt', 'MOT17-04-SDP/gt/gt.txt',
                  'MOT17-02-SDP/gt/gt.txt']
    json_file = '/mnt/liucen/MOT_det/coco_mot17/annotations/instances_train2017.json'
